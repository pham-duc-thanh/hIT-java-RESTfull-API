...
public class CompanyController {
  ...
  public ResponseEntity<Company> createNewCompany(@Valid @RequestBody Company postManUser) {

    Company thanhCompany = this.companyService.handleCreateCompany(postManUser);
